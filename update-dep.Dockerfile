...
COPY --chown=dev:dev src/chillbox/_version.py /home/dev/app/src/chillbox/_version.py
COPY --chown=dev:dev dep /home/dev/app/dep
COPY --chown=dev:dev README.md /home/dev/app/README.md
COPY --chown=dev:dev LICENSE /home/dev/app/LICENSE
...
COPY --chown=dev:dev src/chillbox/ /home/dev/app/src/chillbox/
RUN <<BANDIT
